 ...
 * @description Renderizador de previsualización atómico que utiliza estilos
 *              en línea para ser compatible con @vercel/og.
 * @version 4.1.0 (Code Hygiene): Se elimina la importación no utilizada.
