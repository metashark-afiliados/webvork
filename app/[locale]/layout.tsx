...
export default async function LocaleLayout({
  ...
  if (error) {
    logger.error(
      `[LocaleLayout] No se pudo cargar el diccionario para [${safeLocale}].`, { error }
    );
  }
  ...
  const showDevHomepageHeader = process.env.NODE_ENV === "development" && isHomePage && devHomepageHeaderContent && devRouteMenuContent;
